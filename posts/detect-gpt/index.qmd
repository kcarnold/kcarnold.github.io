...
description: "It's risky, encourages an arms race, and distracts."
author: "Ken Arnold"
date: "2023-01-17"
categories: [ai, ml, lm]
---
...
2. It's just going to lead to an **arms race**. We've already seen examples of how simple tweaks to how the system is used (e.g., telling it to introduce mistakes) can sneak past some ways of detection. If there's a clear signal of computer generation, the bad actors will find a way around it. Meanwhile the false positive rate will go up (see #1).
